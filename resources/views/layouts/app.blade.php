...
<head>
    ...
    <title class="stroke">Sistema Inventario UNA</title>
...
<li class="nav-item {{ request()->is('role') ? 'active' : '' }}">
           ...
           <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
			...
			@endcan
                ...
                <li class="nav-item {{ request()->is('helpage') ? 'active' : '' }}">
                            <a href="{{ route('helpage') }}" class="nav-link">{{ __('Ayuda') }}</a>
					</li>
